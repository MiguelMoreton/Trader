...
df_ops.to_csv("operaciones_detalladas.csv",index=False)
df_equity.to_csv("curva_equity.csv",index=False)
resumen_acciones.to_csv("resumen_por_accion.csv")
resumen_anual_accion.to_csv("resumen_anual_por_accion.csv")

print("\n📁 Archivos generados:")
print("- operaciones_detalladas.csv")
print("- curva_equity.csv")
print("- resumen_por_accion.csv")
print("- resumen_anual_por_accion.csv")
