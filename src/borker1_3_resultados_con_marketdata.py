...
# ==============================
# GUARDA DATOS DE MERCADO (para heatmaps)
# ==============================

_output_dir = "resultados"
os.makedirs(_output_dir, exist_ok=True)
_script_name = os.path.splitext(os.path.basename(__file__))[0]

market_data_path = os.path.join(_output_dir, f"{_script_name}_market_data.parquet")
df.to_parquet(market_data_path, index=False)

print(f"📦 Dataset de mercado guardado: {market_data_path}")
